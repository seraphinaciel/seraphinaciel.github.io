...
.variable p{height:200px;background: var(--img);background-size:contain;}
.variable h4:first-child{--size: 8em;height: var(--size);background:white;}
.variable h4:last-child{--size: calc(var(--size) + 1em);background:white;}

...
1.**alt 태그**
```html
<img src="/assets/images/15.jpg" alt="큰 햄버거를 들고 있는 모습">
```
...
![](/assets/images/images/wa_img01.jpg)
...
![](/assets/images/images/wa_img02.jpg) 
![](/assets/images/images/wa_img03.jpg)

2. **슬라이드 이미지 박스 : 기타 순서상 제목 → 제어버튼 → 내용 순을 권장** 
![](/assets/images/images/wa_img04.jpg)

3. **상단 메뉴 : 메뉴열기 → 메뉴 → 메뉴닫기가 키보드 흐름상 논리적**
![](/assets/images/images/wa_img05.jpg)

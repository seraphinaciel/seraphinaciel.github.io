...
<ul class="cSelector">
	...
	<li><img src="/assets/images/cSel_good.gif" alt="좋아요"> &nbsp; <img src="/assets/images/cSel_bad.gif" alt="싫어요"></li>
</ul>
```html
<li><img src="/assets/images/cSel_img.jpg" alt="나무위키 훈민정음 헤례본 원문" width="250"></li>
<li><a href="/" title="새창으로 열립니다." target="_blank">세종어제 훈민정음</a></li>
...
"마지막 요소 선택",
"n번째 요소 선택",
"-child(n) : 부모의 모든 자식(첫째부터 막내까지) 중 n번 째, -of-type(n) : 부모의 특정 자식(천재, 귀염둥이, 막둥이) 중 n번째",
"홀수번째 요소 선택",
"짝수번째 요소 선택",
"3번째부터 마지막까지 선택",

...
<div class="checkBox">
	...
	<label class="ch_in" for="rgrade"><span><svg><polyline points="1.5 6 4.5 9 12.5 1"></polyline></svg></span> checked = 페이지가 로드될 때 <input>가 미리 선택type="checkbox" / type="radio"</label>
</div>
